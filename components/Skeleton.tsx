                ...
                <div className="h-full border-2 border-gray-200 rounded-lg overflow-hidden">
                    ...
                    <div className="p-6">
                        ...
                        <div className="flex items-center flex-wrap ">
                            <a className="bg-red-300 h-4 animate-pulse mt-2 w-32 inline-flex items-center md:mb-2 lg:mb-0">

                            </a>
                            <span className="bg-red-300 w-16 mt-2 h-4 animate-pulse mr-3 px-2 inline-flex items-center ml-auto leading-none text-sm pr-5 py-1">
